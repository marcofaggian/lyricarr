...
export namespace $default {
  export interface Album extends std.$Object {
    "name": string;
    "artist": Artist;
    "songs": Song[];
  }
  export interface Artist extends std.$Object {
    "name": string;
    "albums": Album[];
  }
...
import Album = $default.Album;
import Artist = $default.Artist;
import Song = $default.Song;
export type {
  Album,
  Artist,
  Song

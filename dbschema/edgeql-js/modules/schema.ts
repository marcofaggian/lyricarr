...
export type $ObjectTypeλShape = $.typeutil.flatten<$SourceλShape & Omit<$ConsistencySubjectλShape, "<subject"> & $InheritingObjectλShape & Omit<$TypeλShape, "<target"> & $AnnotationSubjectλShape & {
  ...
  "<__type__[is Album]": $.LinkDesc<_default.$Album, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Artist]": $.LinkDesc<_default.$Artist, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Song]": $.LinkDesc<_default.$Song, $.Cardinality.Many, {}, false, false,  false, false>;
